...
<script type="text/javascript">
    $(function() {
    	...
    	$('#isinsonucu').puiinputtextarea();
    });
</script>

<script type="text/javascript">
	function myFunction() {
		var sonuc = document.forms["isolustur"]["isinsonucu"].value;
		if(sonuc == null || sonuc == "") {
			alert("Sonuç alanı boş olamaz");
			return false;
		}
		return true;
	}
 ...
 %><b class="caret"></b></a>
		...
		<div id="page-wrapper">
			...
			<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-offset-login" style="margin-left: 180px;">
				...
				<form method="post" action="/IsTakip/departmentofficer/is_ayrinti" id="isolustur" onsubmit="return myFunction();">
					<textarea name=isinsonucu id="isinsonucu" rows="5" cols="30" style="height: 135px; width: 460px;"></textarea>
					<br><br><br>
