...
<script type="text/javascript">  
    $(function() {
    	...
    	$('#isozeti').puiinputtextarea();
    	$('#isbasligi').puiinputtext();
    	
    });
</script>
<script type="text/javascript">
	function myFunction() {
		var baslik = document.forms["isolustur"]["isbasligi"].value;
		var ozet = document.forms["isolustur"]["isozeti"].value;
		if (baslik == null || baslik == "") {
			alert("Başlık alanı boş olamaz");
			return false;
		} else if(ozet == null || ozet == "") {
			alert("özet alanı boş olamaz");
			return false;
		} 
		return true;
	}
 ...
 %><b class="caret"></b></a>
		...
		<div id="page-wrapper">
			...
			<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-offset-login" style="margin-left: 180px;">
				...
				<form method="post" action="/IsTakip/departmentofficer/is_amac" id="isolustur" onsubmit="return myFunction();">
					Başlık&nbsp;:&nbsp;<input type="text" id="isbasligi" name="isbasligi" style="width: 460px;">
					<br><br><br>
					<table><tr><td valign="middle">Özet&nbsp;&nbsp;:&nbsp;</td><td><textarea name="isozeti" id="isozeti" rows="5" cols="30" style="height: 135px; width: 460px;"></textarea></td></tr></table>
					<br><br>
					<button id="submitbutton" type="submit" style="margin-left: 200px;" >Devam</button>
				</form>
				<div align="center">
							<%
