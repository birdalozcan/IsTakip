...
<body>
 ...
 %><b class="caret"></b></a>
					...
					<ul class="nav navbar-nav side-nav" style="width: 225px; min-height: 600px; background-color: #F3F3F3; margin-top: 0px;">
						<li class="active"><a href="/IsTakip/departmentofficer/profil_bilgilerim"><i class="glyphicon glyphicon-pencil"></i> Profil Bilgilerim</a></li>
		...
		<div id="page-wrapper">
			...
			<div
				...
				<form id="profil" action="/IsTakip/departmentofficer/bilgilerimiguncelle"
