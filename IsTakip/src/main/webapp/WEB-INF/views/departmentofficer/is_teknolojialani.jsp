...
<script type="text/javascript">  
    $(function() {
    	...
    	$('#isinteknolojialani').puiinputtextarea();
    });
</script>
<script type="text/javascript">
	function myFunction() {
		var teknoalani = document.forms["isolustur"]["isinteknolojialani"].value;
		if(teknoalani == null || teknoalani == "") {
			alert("Teknoloji Alanı boş olamaz");
			return false;
		}
		return true;
	}
...
<body>
 ...
 %><b class="caret"></b></a>
		...
		<div id="page-wrapper">
			<h2>İşin İlgili Olduğu Teknoloji Alan(lar)ı</h2>
			<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-offset-login" style="margin-left: 180px;">
				
				<form method="post" action="/IsTakip/departmentofficer/is_YontemveMetodlar" id="isolustur" onsubmit="return myFunction();">
					<textarea name="isinteknolojialani" id="isinteknolojialani" rows="5" cols="30" style="height: 135px; width: 460px;"></textarea>
					<br><br><br>
