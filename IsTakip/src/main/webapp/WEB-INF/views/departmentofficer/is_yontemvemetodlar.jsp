...
<script type="text/javascript">  
    $(function() {
    	...
    	$('#isinyontemvemetodu').puiinputtextarea();
    });
</script>
<script type="text/javascript">
	function myFunction() {
		var yontem = document.forms["isolustur"]["isinyontemvemetodu"].value;
		if(yontem == null || yontem == "") {
			alert("Yöntem ve Metod alanı boş olamaz");
			return false;
		}
		return true;
	}
...
<body>
 ...
 %><b class="caret"></b></a>
		...
		<div id="page-wrapper">
			<h2>Kullanılacak Yöntem ve Metodlar</h2>
			<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-offset-login" style="margin-left: 180px;">
				
				<form method="post" action="/IsTakip/departmentofficer/is_sonuc" id="isolustur" onsubmit="return myFunction();">
					<textarea name="isinyontemvemetodu" id="isinyontemvemetodu" rows="5" cols="30" style="height: 135px; width: 460px;"></textarea>
					<br><br><br>
