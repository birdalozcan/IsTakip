...
<script type="text/javascript">  
    $(function() {
    	...
    	$('#isinyenilikunsuru').puiinputtextarea();
    });
</script>
<script type="text/javascript">
	function myFunction() {
		var yenilikunsuru = document.forms["isolustur"]["isinyenilikunsuru"].value;
		if(yenilikunsuru == null || yenilikunsuru == "") {
			alert("Yenilik Unsuru alanı boş olamaz");
			return false;
		}
		return true;
	}
...
<body>
 ...
 %><b class="caret"></b></a>
		...
		<div id="page-wrapper">
			<h2>İşin İçerdiği Yenilik Unsuru</h2>
			<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-offset-login" style="margin-left: 180px;">
				
				<form method="post" action="/IsTakip/departmentofficer/is_teknolojiAlani" id="isolustur" onsubmit="return myFunction();">
					<textarea name=isinyenilikunsuru id="isinyenilikunsuru" rows="5" cols="30" style="height: 135px; width: 460px;"></textarea>
					<br><br><br>
