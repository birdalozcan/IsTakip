...
<body>
	<%
		...
		if (session.getAttribute("user") != null) {
			...
			ArrayList<String> listdep = (ArrayList<String>) request.getAttribute("listdep");
		...
		<div id="printable">
			...
			<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-offset-login" style="margin-left: 150px;">
					...
					<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-offset-login" style="margin-left: 150px; margin-top: 0px;">
								<form action="/IsTakip/manager/isSil" method="post"><b><font color="red"><% session.setAttribute("isbeanid", isbean.getIsid()); %><button type="submit" class="submit">İŞİ SİL</button></font></b></form><br><br>
								
								<p><a href="/IsTakip/manager/atanmis_isler">Geri</a></p>
								
								<form action="/IsTakip/manager/atanmisisBilgileri" method="post"  id="commentform" onsubmit="return myFunction();">	
									<p><textarea id="comment" name="comment" rows="5" cols="10" placeholder="Yorum Yap" style="width: 500px;"></textarea></p>
									<div align="left" style="margin-left: 396px;"><input type="hidden" value="<%=isbean.getIsid()%>" name="isbean" id="isbean"> <button id="leavecomment" type="submit" >Yorum Yap</button></div>
								</form>
								<br><br>
								<% 
