...
<script type="text/javascript">
	$(function() {
		$('#inputdepad').puiinputtext();
		$('#inputdepsoyad').puiinputtext();
		$('#inputdeptel').puiinputtext();
		$('#inputdepeposta').puiinputtext();
		$('#deppopPassword').puipassword();
		$('#depadi').puidropdown();
...
<script type="text/javascript">
	function kontrol() {
		var ad = document.forms["depgorv"]["depad"].value;
		var soyad = document.forms["depgorv"]["depsoyad"].value;
		var telefon = document.forms["depgorv"]["deptelefon"].value;
		var email = document.forms["depgorv"]["depemail"].value;
		var sifre = document.forms["depgorv"]["depsifre"].value;
...
<body>
 ...
 %><b class="caret"></b></a>
				...
				<ul class="nav navbar-nav side-nav"
					...
					<li class="active"><a
						href="/IsTakip/manager/dep_gorevlisi_ekle"><i
		...
		<div id="page-wrapper">
			<h2>Departman Görevlisi Ekle</h2>
			<div
				class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-offset-login">
				<form id="depgorv" action="/IsTakip/manager/depgorevlisiekle" method="post" onsubmit="return kontrol();">
					<table border="0" width="498" height="345">
						<tr>
							<td height="40" width="80">Ad :</td>
							<td height="40" width="418"><input id="inputdepad"
								name="depad" type="text" /></td>
						</tr>
						<tr>
							<td height="43" width="80">Soyad :</td>
							<td height="43" width="418"><input id="inputdepsoyad"
								name="depsoyad" type="text" /></td>
						</tr>
						<tr>
							<td height="40" width="80">Telefon :</td>
							<td height="40" width="418"><input id="inputdeptel"
								name="deptelefon" type="text" /></td>
						</tr>
						<tr>
							<td height="40" width="80">E-Posta :</td>
							<td height="40" width="418"><input id="inputdepeposta"
								name="depemail" type="text" /></td>
						</tr>
						<tr>
							<td height="45" width="80">Şifre :</td>
							<td height="45" width="418"><input id="deppopPassword"
								name="depsifre" type="password" /></td>
						</tr>
						<tr>
							<td height="40" width="80">Dep. Adı :</td>
							<td height="40" width="418"><select style="width: 140px;"
								id="depadi" name="depadi">
									<%
										for (int i = 0; i < list.size(); i++) {
									%>
									<option value="<%=list.get(i).getDep_aciklama()%>"><%=list.get(i).getDep_aciklama()%></option>
									<%
										}
									%>
							</select></td>
						...
						<tr>
							...
							<td height="45" width="418"><button id="butonguncelle"
									style="margin-left: 70px;" type="submit">Dep. Gör.
									Ekle</button></td>
						</tr>
					</table>
				</form>
