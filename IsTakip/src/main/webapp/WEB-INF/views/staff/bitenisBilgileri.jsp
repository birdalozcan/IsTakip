...
<body>
 ...
 %><b class="caret"></b></a>
				...
				<ul class="nav navbar-nav side-nav" style="width: 225px; min-height: 600px; background-color: #F3F3F3; margin-top: 0px;">
					...
					<li class="active"><a href="/IsTakip/staff/biten_isler"><i class="glyphicon glyphicon-ok-sign"></i> Biten İşler</a></li>
		...
		<div id="printable">
			...
			<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-offset-login" style="margin-left: 150px;">
				...
				<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-offset-login" style="margin-left: 150px; margin-top: 0px;">
								<% if(isbean.getPersonelisbitimi() == 0) { 
									System.out.println("isbean.getPersonelisbitimi() bitenisbilgileri.jsp"+isbean.getPersonelisbitimi());
								%>
									<table>
										<tr>
								...
								<%	} else { %>
								<font color="red">İşi bitirdin.</font>
								<%  } %>
								<br>
								<% session.setAttribute("isbeanid", isbean.getIsid()); %>
								<br>
								<p><a href="/IsTakip/staff/biten_isler">Geri</a></p>
								<br>
								<form action="/IsTakip/staff/bitenisBilgileri" method="post"  id="commentform" onsubmit="return myFunction();">	
