	...
	function checkcontrol() {
		...
		if(document.getElementById("chk1").checked == true) {
			...
			if(answer == true) {
				...
				window.location.href = "/IsTakip/staff/isBitimi";
			}
		}
	}
</script>
		...
		<div id="printable">
			...
			<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-offset-login" style="margin-left: 150px;">
				...
				<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-offset-login" style="margin-left: 150px; margin-top: 0px;">
								...
								<br><br>
								<p><a href="/IsTakip/staff/devam_eden_isler">Geri</a></p>
								<br>
								<form action="/IsTakip/staff/devamedenisBilgileri" method="post"  id="commentform" onsubmit="return myFunction();">	
